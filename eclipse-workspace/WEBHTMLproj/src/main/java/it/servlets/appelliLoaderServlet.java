...
public class appelliLoaderServlet extends ThymeleafServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try (Connection conn = DataBaseConnection.getConnection()) {
			...
			while (rs.next()) {
				anyResult = true;
				ExamResult temp = new ExamResult(Integer.parseInt(idAppello), corso, rs.getString("date"),
						rs.getString("result"), rs.getString("status"), rs.getInt("idStudent"), rs.getString("name"),
